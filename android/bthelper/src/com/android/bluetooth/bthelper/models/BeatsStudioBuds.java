...
public class BeatsStudioBuds {

    private static final String TAG = "BtHelper";

    private static final byte[] LOW_BATTERY_THRESHOLD = (""+20).getBytes();

    private static final byte[] MANUFACTURER_NAME = "Beats Electronics, LLC.".getBytes();
    private static final byte[] MODEL_NAME = "Beats Studio Buds".getBytes();
    ...
    private static int getModelColor(int color) {
        switch (color) {
            case 0: return R.drawable.Beats_Studio_Buds_White; // White
            case 1: return R.drawable.Beats_Studio_Buds_Black; // Black
            case 2: return R.drawable.Beats_Studio_Buds_BeatsRed; // Red
            case 3: return R.drawable.Beats_Studio_Buds_OceanBlue; // Blue
            case 4: return R.drawable.Beats_Studio_Buds_SunsetPink; // Pink
            case 5: return R.drawable.Beats_Studio_Buds_MoonGray; // Gray
            // case 6: return 6; // Silver
            // case 7: return 7; // Gold
            // case 8: return 8; // RoseGold
            // case 9: return 9; // SpaceGray
            // case 10: return 10; // DarkBlue
            // case 11: return 11; // LightBlue
            // case 12: return 12; // Yellow
            // case 16: return 16; // Green (Guessing)
            // case 17: return 17; // Ivory (Guessing)
            default: return R.drawable.Beats_Studio_Buds_White; // White
        }
    };
    private static int getModelColorLeft(int color) {
        switch (color) {
            case 0: return R.drawable.Beats_Studio_Buds_White_Left; // White
            case 1: return R.drawable.Beats_Studio_Buds_Black_Left; // Black
            case 2: return R.drawable.Beats_Studio_Buds_BeatsRed_Left; // Red
            case 3: return R.drawable.Beats_Studio_Buds_OceanBlue_Left; // Blue
            case 4: return R.drawable.Beats_Studio_Buds_SunsetPink_Left; // Pink
            case 5: return R.drawable.Beats_Studio_Buds_MoonGray_Left; // Gray
            // case 6: return 6; // Silver
            // case 7: return 7; // Gold
            // case 8: return 8; // RoseGold
            // case 9: return 9; // SpaceGray
            ...
            // case 16: return 16; // Green (Guessing)
            // case 17: return 17; // Ivory (Guessing)
            default: return R.drawable.Beats_Studio_Buds_White_Left; // White
        }
    };
    private static int getModelColorRight(int color){
        switch (color) {
            case 0: return R.drawable.Beats_Studio_Buds_White_Right; // White
            case 1: return R.drawable.Beats_Studio_Buds_Black_Right; // Black
            case 2: return R.drawable.Beats_Studio_Buds_BeatsRed_Right; // Red
            case 3: return R.drawable.Beats_Studio_Buds_OceanBlue_Right; // Blue
            case 4: return R.drawable.Beats_Studio_Buds_SunsetPink_Right; // Pink
            case 5: return R.drawable.Beats_Studio_Buds_MoonGray_Right; // Gray
            // case 6: return 6; // Silver
            // case 7: return 7; // Gold
            // case 8: return 8; // RoseGold
            // case 9: return 9; // SpaceGray
            ...
            // case 16: return 16; // Green (Guessing)
            // case 17: return 17; // Ivory (Guessing)
            default: return R.drawable.Beats_Studio_Buds_White_Right; // White
        }
    };
    private static int getModelColorCase(int color) {
        switch (color) {
            case 0: return R.drawable.Beats_Studio_Buds_White_Case; // White
            case 1: return R.drawable.Beats_Studio_Buds_Black_Case; // Black
            case 2: return R.drawable.Beats_Studio_Buds_BeatsRed_Case; // Red
            case 3: return R.drawable.Beats_Studio_Buds_OceanBlue_Case; // Blue
            case 4: return R.drawable.Beats_Studio_Buds_SunsetPink_Case; // Pink
            case 5: return R.drawable.Beats_Studio_Buds_MoonGray_Case; // Gray
            // case 6: return 6; // Silver
            // case 7: return 7; // Gold
            // case 8: return 8; // RoseGold
            // case 9: return 9; // SpaceGray
            ...
            // case 16: return 16; // Green (Guessing)
            // case 17: return 17; // Ivory (Guessing)
            default: return R.drawable.Beats_Studio_Buds_White_Case; // White
        }
    }
    ...
    public static void setModelMetaData(Context context, BluetoothDevice mCurrentDevice) {
        ...
        if (isModelIconSet == false) {
            ...
            MODEL_ICON_URI = 
                    AirPodsUtils.resToUri(context, getModelColor(color), packageNames).toString().getBytes();
            MODEL_ICON_URI_LEFT = 
                    AirPodsUtils.resToUri(context, getModelColorLeft(color), packageNames).toString().getBytes();
            MODEL_ICON_URI_RIGHT = 
                    AirPodsUtils.resToUri(context, getModelColorRight(color), packageNames).toString().getBytes();
            MODEL_ICON_URI_CASE = 
                    AirPodsUtils.resToUri(context, getModelColorCase(color), packageNames).toString().getBytes();
